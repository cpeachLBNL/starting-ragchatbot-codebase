...
class TestAIGenerator(unittest.TestCase):
    ...
    def test_system_prompt_content(self):
        ...
        print(f"   - Contains search tool: {'search_course_content' in prompt_template}")
        print(f"   - Contains outline tool: {'get_course_outline' in prompt_template}")
        print(f"   - Contains sequential features: {'Sequential reasoning' in prompt_template}")
    ...
    def test_generate_response_with_conversation_history(self, mock_anthropic):
        ...
        print(f"   - Response: {response}")
        print(f"   - History included in system: {'Previous conversation' in call_args.kwargs['system']}")
    ...
    def test_helper_methods_functionality(self, mock_anthropic):
        ...
        print(f"   - System content includes conversation: {'Previous conversation' in system_content}")
    ...
    def test_sequential_tool_calling_two_rounds(self, mock_anthropic):
        ...
        self.assertEqual(mock_client.messages.create.call_count, 3)  # 2 tool rounds + final
