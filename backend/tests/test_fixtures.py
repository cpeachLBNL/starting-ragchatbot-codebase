...
class MockData:
        ...
        Course(
            ...
            lessons=[
                Lesson(
                    lesson_number=0,
                    title="Introduction",
                    lesson_link="https://learn.deeplearning.ai/lesson/intro",
                ),
                Lesson(
                    lesson_number=1,
                    title="API Basics",
                    lesson_link="https://learn.deeplearning.ai/lesson/basics",
                ),
                Lesson(
                    lesson_number=2,
                    title="Multi-modal Requests",
                    lesson_link="https://learn.deeplearning.ai/lesson/multimodal",
                ),
            ],
        ),
        Course(
            ...
            lessons=[
                Lesson(
                    lesson_number=1,
                    title="What is RAG?",
                    lesson_link="https://learn.deeplearning.ai/lesson/rag-intro",
                ),
                Lesson(
                    lesson_number=2,
                    title="Vector Databases",
                    lesson_link="https://learn.deeplearning.ai/lesson/vector-db",
                ),
            ],
        ),
    ]
    ...
    EMPTY_SEARCH_RESULTS = SearchResults(documents=[], metadata=[], distances=[])
...
class MockVectorStore:
    ...
    def get_existing_course_titles(self) -> List[str]:
        """Mock course titles"""
        return (
            [course.title for course in MockData.SAMPLE_COURSES]
            if self.return_data
            else []
        )
...
class MockAnthropicClient:
    ...
    def create(self, **kwargs):
        ...
        return MockAnthropicClient.MockResponse(
            simulate_tool_use=self.simulate_tool_use, simulate_error=self.simulate_error
        )
...
def assert_course_outline_format(result: str):
    ...
    assert (
        "**Lessons:**" in result or "No lesson information" in result
    ), "Course outline should include lessons section"
